...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Calculate probability of number of genes from parents:
        else:
        ...
        # Multiply for the probability of that person with or without X gene
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        # Evaluate the total probability for each distribution
